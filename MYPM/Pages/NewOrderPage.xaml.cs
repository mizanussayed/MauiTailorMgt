...
public partial class NewOrderPage : ContentPage
{
    ...
    private static Grid CreateArabianGrid()
    {
        ...
        var labels = new[] { "লম্বা", "তিরা", "হাতা", "বের", "কফ", "মুহরী", "কমর", "রাকাবা", "নেছ" };
        var bindings = new[] { "ArabianOrder.Length", "ArabianOrder.Tira", "ArabianOrder.Hata", "ArabianOrder.Ber", "ArabianOrder.Cuff", "ArabianOrder.Mohori", "ArabianOrder.Komor", "ArabianOrder.Rakaba", "ArabianOrder.Ness" };
        var entries = labels.Zip(bindings, EntryWithLabel).ToArray();
        for (int i = 0; i < entries.Length; i++)
        {
            measurementGrid.Add(entries[i], i % 3, i / 3);
